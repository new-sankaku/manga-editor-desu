...
'- These are named because the tag you would reach for first is the wrong one, not because they are',
'  a list to work through. Pick the one rung that matches the panel. From held-in to blown open:',
...
'  Do not put the same rung on two panels in a row either. A face that never changes reads as a mask.',
