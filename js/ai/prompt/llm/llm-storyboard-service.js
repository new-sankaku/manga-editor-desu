...
'  different place.',
'- What replaces a dropped background depends on why you dropped it: emptiness to isolate, speed',
'  to carry motion, something radiating to hit. Those are kinds, not tags to copy; pick what this',
'  panel is doing. Reaching for the same one every time makes the page look mechanical.',
'',
...
'    name whatever is above their head in that place, and the frame opens upward to hold it.',
'      What that is depends on where they are, so read the location and take it from there.',
...
'  finished picture. Each one covers everything from faint to extreme, and what the model has',
'  settled on as the middle of that range is an illustration-sized expression, well past what a',
'  manga panel wants. Naming the emotion gets you that middle every time, with no way to aim.',
...
'The vocabulary for that, with how many pictures on Danbooru carry each tag. The count tells you',
'two things and no more. A tag in the hundreds was barely learnt and will do nothing. A tag in the',
'millions is something the model draws readily whether you ask or not, which is why the mouth opens',
'and the eyes find the camera unless you say otherwise.',
'The count does not tell you how much a tag changes the picture when you do use it. That depends on',
'how narrow the tag is: "glaring" at 12k names one thing and lands, "serious" at 39k is vague and',
'often does little.',
'This is not a list to choose from, and tags outside it are fine.',
...
'- Anything named in these instructions is an example of a kind of thing, shown so you know what',
'  kind is meant. It is never a tag to use. You know the Danbooru vocabulary; pick the tag this',
'  panel actually needs, in this place, for these people. If an example happens to fit, that is a',
