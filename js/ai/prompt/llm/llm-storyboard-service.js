...
'- scenery: mood, weather, time passing. No people. Something in the place, held still.',
'- insert: one detail on its own. An object, or one part of a person.',
...
'Output:',
// 形の例に具体的な役割名を書くと1コマ目がその役割に引っ張られる。placeholderにする
...
// 例を並べると全コマに同じタグを入れてくる。ここで先に釘を刺す
...
'- To show a place, name the things that are actually in that place and large enough to fill a frame.',
...
'  a closeup, an insert or an impact panel. What goes in its place depends on why you dropped it:',
'  emptiness to isolate, streaks to carry speed, radiating lines to hit. Pick the one that matches',
'  this panel. Reaching for the same one every time is how a page starts to look mechanical.',
...
'- Open every panel that shows people with the Danbooru count tags for the people actually in it.',
'  Count them in that panel. Do not carry a count over from the panel before.',
